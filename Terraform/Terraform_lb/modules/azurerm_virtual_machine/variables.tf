...
variable "subnet_name" {
  description = "The name of the subnet where the VM's NIC will be connected."
  type        = string  
}
...
variable "nsg_name" {
  description = "The name of the Network Security Group to associate with the VM's NIC."
  type        = string  
}
