import {
  to = azuread_group.all_users_group
  id = "28de795f-c463-42b3-b51b-15cb1489f19c"
}

resource "azuread_group" "all_users_group" {
  display_name     = "devops"
  security_enabled = true
}

# resource "azuread_user" "raj" {
#   user_principal_name = "raj.kumar@yashwants112outlook.onmicrosoft.com"
#   display_name        = "Raj Kumar"
#   mail_nickname       = "rajkumar"
#   password            = "Temp@12345"
# }

locals {
  new_users = [
    "user1@yashwants112outlook.onmicrosoft.com",
    "user2@yashwants112outlook.onmicrosoft.com",
    "user3@yashwants112outlook.onmicrosoft.com",
    "user4@yashwants112outlook.onmicrosoft.com",
    "user5@yashwants112outlook.onmicrosoft.com",
    "user6@yashwants112outlook.onmicrosoft.com",
    "user7@yashwants112outlook.onmicrosoft.com",
    "user8@yashwants112outlook.onmicrosoft.com",
    "user9@yashwants112outlook.onmicrosoft.com",
    "user10@yashwants112outlook.onmicrosoft.com"
  ]
}


resource "azuread_user" "bulk_users" {
  for_each = toset(local.new_users)

  user_principal_name = each.value
  display_name        = each.value
  mail_nickname       = replace(split("@", each.value)[0], ".", "")
  password            = "Temp@12345"
}
...
# data "azuread_user" "intern" {
#   for_each = toset(local.devops_intern_user)
#   object_id = each.value
# }

# # --------- 4) Users ko naye group me add karo ---------
# resource "azuread_group_member" "devops_intern_member" {
#   for_each = data.azuread_user.intern

#   group_object_id  = azuread_group.all_users_group.id
...
#   # ye automatically tenant ke sab users le aata hai
#   return_all = true
# }

# # --------- 3) Sab users ko group me add karo ---------
# resource "azuread_group_member" "all_users_members" {
#   for_each = toset(data.azuread_users.all.object_ids)
